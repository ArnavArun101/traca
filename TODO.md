...
- [x] WebSocket message validation & chat context loading
- [x] Resolve merge conflicts and runtime blockers
...
- [x] Deriv flows verified (ticks, indicators, alerts, trade history)
...
- [ ] Authentication & authorization (JWT auth in place; protect routes next)
